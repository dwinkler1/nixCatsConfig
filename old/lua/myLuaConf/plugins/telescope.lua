...
return {
  {
    ...
    keys = {
      ...
      { "<leader>bs", function() return require('telescope.builtin').buffers() end, mode = {"n"}, desc = '[ ] Find existing buffers', },
      { "<leader>s.", function() return require('telescope.builtin').oldfiles() end, mode = {"n"}, desc = '[S]earch Recent Files ("." for repeat)', },
      { "<leader>sb", function() return require('telescope.builtin').buffers() end, mode = {"n"}, desc = '[S]earch [b]uffers', },
